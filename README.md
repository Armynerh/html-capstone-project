...
# 📖 [HTML-Capstone-Dev_Dome] <a name="about-project"></a>


**[Dev Dome]** is a capstone project at microverse built using HTML, CSS, & JavaScript.
...
```sh
  cd my-folder
  git clone https://github.com/Armynerh/html-capstone-project.git
```
